...
public class AlarmScheduler {
    ...
    {
        AlarmManager manager=AlarmManagerProvider.getsAlarmManager(context);
        PendingIntent operation= com.example.todolistapp.reminder.ReminderAlarmService.getReminderPendingIntent(context,reminderTask);
